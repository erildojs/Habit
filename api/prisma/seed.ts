...
const secondHabitCreationDate = new Date('2024-02-03T03:00:00.000')

const thirdHabitId = 'fa1a1bcf-3d87-4626-8c0d-d7fd1255ac00'
const thirdHabitCreationDate = new Date('2024-02-08T03:00:00.000')
...
async function run() {
  ...
  await Promise.all([
    ...
    prisma.day.create({
      data: {
        /** Segunda */
        date: new Date('2024-02-02T03:00:00.000z'),
        dayHabits: {
          create: {
    ...
    prisma.day.create({
      data: {
        /** Friday */
        date: new Date('2024-02-06T03:00:00.000z'),
        dayHabits: {
          create: {
    ...
    prisma.day.create({
      data: {
        /** Wednesday */
        date: new Date('2024-02-04T03:00:00.000z'),
        dayHabits: {
